...
hero_label: 'Nagelstudio · Tilburg'
hero_heading: 'Verzorgde nagels met BIAB en gespecialiseerde pedicure in Tilburg'
hero_sub: 'Nail Studio By Sav is een nagelstudio in Tilburg, gespecialiseerd in BIAB en gespecialiseerde pedicure.'
...
trust:
  ...
  - 'Afspraak maken via Instagram'

# ABOUT — the owner's story: experience + personality + what the customer gets.
about_heading: 'Over Nail Studio By Sav'
about: |
  Nail Studio By Sav is een nagelstudio in Tilburg, gespecialiseerd in BIAB en
  gespecialiseerde pedicure. Deze pagina is een eerste, nog te bevestigen
...
services:
  - title: 'BIAB'
    body: 'Sterke, natuurlijk ogende nagels met een duurzame BIAB-behandeling.'
  - title: 'Gespecialiseerde pedicure'
    body: 'Verzorgde voeten met een gespecialiseerde pedicurebehandeling.'
...
contact_email: 'nailstudiobysav@outlook.com'
address: |
  Enschotsestraat 143
  5014 DD Tilburg
# maps_url: ''
...
# SOCIAL
instagram_url: 'https://www.instagram.com/nailstudiobysav/'
# facebook_url: ''
