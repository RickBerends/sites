...
hero_sub: 'Bij Nienke is een kapsalon in Tilburg waar u terechtkunt voor een knipbeurt die bij u past, vlakbij in de buurt.'
...
trust:
  - '4,7★ op Google (155 reviews)'
  - 'Aan de Oerlesestraat in Tilburg'
  - '6 dagen per week geopend (dinsdag t/m zaterdag)'

# ABOUT — the owner's story: experience + personality + what the customer gets.
about_heading: 'Over Bij Nienke'
about: |
  Bij Nienke is een kapsalon aan de Oerlesestraat in Tilburg. Deze pagina is een
  eerste concept, samengesteld op basis van openbaar beschikbare gegevens
  (adres, openingstijden en beoordelingen), in afwachting van bevestiging door
  de eigenaar. Er is nog geen bevestigd verhaal over de salon of haar
  eigenaar beschikbaar — dat volgt zodra dit is aangeleverd.
...
hours:
  ...
  - { day: 'Dinsdag', open: '08:30 – 17:30' }
  - { day: 'Woensdag', open: '08:30 – 17:30' }
  - { day: 'Donderdag', open: '08:30 – 17:30' }
  - { day: 'Vrijdag', open: '08:30 – 17:30' }
  - { day: 'Zaterdag', open: '08:30 – 15:30' }
...
address: |
  Oerlesestraat 63
  5021 TT Tilburg
maps_url: 'https://www.google.com/maps/search/?api=1&query=51.5471797,5.0800952&query_place_id=ChIJd2oAy06-xkcRep_2C5NtJv8'
