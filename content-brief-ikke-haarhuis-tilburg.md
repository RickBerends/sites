# Content brief — Ikke Haarhuis (Tilburg area, NL)
...
## Hero
- heading: Kappen in de buurt, aan de Hasseltstraat
- sub: Voor bewoners van de Hasseltstraat en omgeving die een kapper om de hoek zoeken in Tilburg.

## About
Ikke Haarhuis is een kapperszaak aan de Hasseltstraat in Tilburg, met een 4,8 uit 12 beoordelingen op Google. Een buurtsalon met een duidelijke plek in de straat, voor wie liever dichtbij huis knipt dan de stad in te hoeven.

Deze tekst is een concept op basis van openbare gegevens; de eigenaar krijgt de ruimte om het verhaal zelf aan te vullen.
...
## Contact & facts
- address: Hasseltstraat 287, 5041 MA Tilburg, Netherlands (source: Google Places API)
- phone: 013 543 5559
- hours:
  - not found (Google Places returned no hours for this listing)
- website: https://nlcompanies.org/details/ikke-haarhuis-ChIJiyy (noted as a source only — not linked from the built site)
- rating: 4.8★ (12 reviews) (source: Google Places API)
...
## Sources
- Google Places API record (place_id: ChIJiyywIyS-xkcR1-qzgLo9nxA), via `kappers_tilburg_enriched.json`
- https://nlcompanies.org/details/ikke-haarhuis-ChIJiyy
...
- Contact email.
- Opening hours (Google Places returned none).
