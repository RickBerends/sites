# Content brief — Kapsalon Roger (Tilburg area, NL)
...
## Hero
- heading: Kapsalon aan de Hasseltstraat in Tilburg
- sub: Een kapsalon in Tilburg, aan de Hasseltstraat.

## About
Kapsalon Roger is een kapsalon gevestigd aan de Hasseltstraat in Tilburg. Voor een uitgebreidere beschrijving van de diensten en werkwijze is meer informatie van de ondernemer zelf nodig.
...
## Contact & facts
- address: Hasseltstraat 264, 5046 LR Tilburg, Netherlands (source: Google Places API)
- phone: not found
- hours:
  - not found (Google Places returned no hours for this listing)
- website: none found (noted as a source only — not linked from the built site)
- rating: not found (source: Google Places API)
...
## Sources
- Google Places API record (place_id: ChIJK_NxoCa-xkcR7S16acmhiIQ), via `kappers_tilburg_enriched.json`
